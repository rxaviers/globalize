/**
 * Globalize Runtime v1.3.0-aaalpha.3
 *
 ...
 *
 * Date: 2017-03-16T17:11Z
 */
/*!
 * Globalize Runtime v1.3.0-aaalpha.3 2017-03-16T17:11Z Released under the MIT license
 * http://git.io/TrdQbw
 */
...
var dateStartOf = function( date, unit ) {
	date = date.isGloblizeDate ? date.clone() : new Date( date.getTime() );
	switch ( unit ) {
		case "year":
			date.setMonth( 0 );
		/* falls through */
